...
wl_EL = np.array([1.215670e+03, 1.640420e+03, 1.661240e+03, 1.666150e+03, 1.906680e+03, 1.908730e+03, 1.54948e+03, 3.727100e+03, 4.862710e+03, 5.008240e+03, 6.564600e+03, 6.585270e+03, 6.718290e+03, 6.732670e+03])
...
for ii_model in range(len(dict_all_combinations)):
    ...
    sp_now.set_tabular_sfh(np.array([0.0, 0.1]), np.array([1.0, 1.0]), Z=None)  # fake for computation here
    idx_EL = []
    for ii_wl in wl_EL:
