...
### Job name
#SBATCH -J 'SP_z7_Z_fid_02'
### output and error logs
#SBATCH -o SP_z7_Z_fid_02_%a.out
#SBATCH -e SP_z7_Z_fid_02_%a.err
### mail
...
--filename_SFH="SFH_z7_Z_fid_02.hdf5" \
--filename_SP="snapshot_z7_Z_fid_02.hdf5" \
